...
def root_window():
    ...
    save_entry_button = Button(input_button_frame, text = 'Save entry', padx=10, pady=2, command=lambda:[lst_of_compound_dicts.append(temp_dict(compound_name_input.get(), compound_ammount_input.get(), str(compound_date_input.get()), var_string.get()),)])
    ...
    #compound_listing = Label(root, text =lambda: f'{compound}\n' for compound in lst_of_compound_dicts)
